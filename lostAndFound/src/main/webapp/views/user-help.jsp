		...
		<div id="container" style="max-width: 100%; min-height: 1000px;">
			<p class="p_info" style="margin: 0 auto; height: 15px; font-size: 14px; color: black;">
				<span style="float: left;">
					现在的位置 <a href="${path}/index.html" target="_self" style="color: #666;">主页</a>-&gt;平台使用指南页面
				</span>
			</p>
			<hr style="margin-top: 0">
			<div id="user-hlep" class="container-fluid" style="margin: 0 auto; min-height: 800px;">
				<p style="font-family: 微软雅黑; line-height: 1.5em">
					<strong style="font-family: Arial; font-weight: bold; font-size: 16px;">${webSiteTitle}
						使用规范如下：
					</strong>
					<br>
					<br>
					...
					<br>
					<br>
					三、遗失物品领取时，凭学生证、身份证、借阅证等有效证件。代他人领取的，还须出示失主的委托书、失主身份证件。领取失物时，需填写《失物领取（交公）记录》。
					<br>
					<br>
					四、校园失物招领平台面向全校师生进行开放，根据全校师生的学号或工号实名注册、登录，让公益以最广、最快的形式进行传播。
					<br>
					<br>
					<b style="color: blue;">
				...
				<div id="myCarousel" class="carousel slide">
					...
					<div class="carousel-inner">
						<div class="active item">
							<img src="${path}/static/images/systemhelp/help.gif"
								style="width: 100%; max-width: 960px; height: 800px;"
						...
						<div class="item">
							<img src="${path}/static/images/systemhelp/login-help.png"
								style="width: 100%; max-width: 960px; height: 800px;"
								oncontextmenu="return false;" ondragstart="return false;">
						</div> --%>
					</div>
			...
			<!-- go to top start-->
			<div id="go-top" class="sr_hidden pull-right"
				style="display: none; position: fixed; bottom: 150px; right: 5px; z-index: 99;">
				<a id="goTop" href="${path}/user-help.html#logo">
					<img src="${path}/static/images/goTop.gif" oncontextmenu="return false;"
						ondargstart="return false;" height="42" width="46" alt="回顶部">
				</a>
			</div>
			<!-- /.go to top end -->
