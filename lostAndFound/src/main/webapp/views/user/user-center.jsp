...
<body style="background: rgb(255, 255, 255); overflow-x: hidden;"> 
   ...
   <div id="pagewrapper" style="margin:0 auto;height:auto;overflow:visible;min-height:800px;*height:800px;">
	...
	<!-- 导航条 end -->
	                         ...
	                         <!--------------页眉结束------------------>				  
	                         <!-------------主体部分开始--------------->
     <div id="details" class="container-fluid" style="max-width:100%;height:auto;"> 
             ...
             <div id="fl_info" title="帖子信息" data-options="iconCls:'icon-zoom-in'">
                 <ul class="tree easyui-tree" data-options="animate:true,lines:true" style="padding: 10px;">
                     <li data-options="iconCls:'icon-search'">
                         <a href="${path}/user/findInfo.html" target="mainFrame" onclick="load(this, '帖子信息');return false;" oncontextmenu="return false;" ondragstart="return false;">查看招领贴列表</a>
                     </li>
                     <li data-options="iconCls:'icon-search'">
                         <a href="${path}/user/lostInfo.html" target="mainFrame" onclick="load(this, '帖子信息');return false;" oncontextmenu="return false;" ondragstart="return false;">查看寻物贴列表</a>
                     </li>
                 </ul>
             </div>
             <div id="s_info" title="系统设置" data-options="iconCls:'icon-cog'">
                  <ul class="tree easyui-tree" data-options="animate:true,lines:true" style="padding: 10px;">
                     <li data-options="iconCls:'icon-edit'">
                         <a href="${path}/user/updateLoginPwd.html" target="mainFrame" onclick="load(this, '系统设置');return false;" oncontextmenu="return false;" ondragstart="return false;">修改登录密码</a>
                     </li>
                 </ul>
             </div>
         </div>
