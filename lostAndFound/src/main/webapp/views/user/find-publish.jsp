...
<head>
	...
	function checkValidForm(form){
		...
		if(form.pickDate.value.trim() == ""){
			form.pickDate.focus();
			valid(form.pickDate, "捡到时间");
			return false;
		}
...
<body style="background: rgb(255, 255, 255); overflow-x: hidden;"> 
   ...
   <div id="pagewrapper" style="margin:0 auto;height:auto;overflow:visible;min-height:800px;*height:800px;">
	...
	<!--------------页眉结束------------------>	
   	...
   	<div id="details" class="container-fluid" style="min-height:550px;"> 
	...
	<hr style="width: 80%; margin:15px auto;"> 
  	...
  	<form action="${path}/find/savePublish.do" method="post" enctype="multipart/form-data" onsubmit="return checkValidForm(this)" >
	 <table style="width: 100%;margin: 0px auto;background-color: #f5f5f5;">
	  ...
	  <tr style="height:30px;">
	   ...
	   <input type="text" name="name" id="name" value="${pickThings.name}" onfocus="valueListenerLimiter(this, 12);" onblur="labelHidden(this);" style="width:180px;margin-top:10px;" maxlength="12">
	  ...
	  <tr style="height:30px;">
	   <td>捡到时间 : </td>
	   <td>
	   <input class="Wdate" type="text" name="pickTime" value="<fmt:formatDate value="${pickThings.pickDate}" pattern="yyyy-M-d" />" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd', maxDate:'%y-%M-%d'})" placeholder="选择日期" readonly style="width: 120px;margin-top:10px;"/>
	  </td>
	  </tr>
	  <tr>
	   <td id="place">捡到地点 : </td>
	  ...
	  <tr>
	   <td>相关描述 : </td>
	   <td>
	   <textarea name="description" id="description" rows="3" cols="10" onfocus="valueListenerLimiter(this, 50);" onblur="labelHidden(this);" style="width:300px;max-width:350px;max-height: 80px;margin-top:10px;text-align: left;">${pickThings.description}</textarea>
	   <span style="color:blue;font-size:12px;"></span>
	   </td>
	  </tr>
	  <tr>
	  ...
	  <tr style="text-align: center;">
	   ...
	   <input type="submit" class="btn btn-info" id="publish" name="publish" value="发帖招领" style="margin-top: 20px;">
	   </td>
	  </tr>	    
	 </tbody>
	 </table>
